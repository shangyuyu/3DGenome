...
let advancedConfig = {
    ...
    mousePickTimeDisp: true,     // log the time cost for each calculation of mouse pick
    mousePickInterval: 250,      // Two calls of rayCaster should wait at least 'mouseSelInterval' ms
